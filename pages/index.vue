  ...
  <div>
    <div class="mainPage">
      ...
      <div class="mainPage_block6">
        ...
        <div class="mainPage_block6_anim">
          <div
            v-for="item in datablock6.squares"
            :key="item.id"
            class="mainPage_block6_anim_square"
            :class="{
              s1: item.id==0,
              s2: item.id==1,
              s3: item.id==2,
          ...
          <a id="block6_btn" class="mainPage_block6_anim_btn btn_blue">{{ datablock6.btn_text }}</a>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    block6Rotate () {
      ...
      this.$anime({
        targets: '.mainPage_block6_anim_btn',
        duration: 700,
        opacity: 1,
        delay: 1000,
        easing: 'linear'
